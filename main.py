...
from keras.layers import Input, Activation, Conv2D, BatchNormalization, Lambda, MaxPooling2D
...
class TextImageGenerator:
    ...
    def next_batch(self):
        ...
        input_length[:] = self._input_len  # 16
        label_length[:] = self._label_len  # 7
...
def train(args):
    ...
    pred_length = int(y_pred.shape[1])  # 16
